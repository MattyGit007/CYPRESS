...
describe('Matts Dyson Homepage Regression Tests', () => {
    ...
    it('7- verify accessibility on manufacturer homepage using Axe plugin', () => {
        ...
        // Logs accessibility violations to the Cypress test runner console using Axe.
        cy.injectAxe();
    ...
    it('9- verify the Dyson navigation bar has the correct tabs and expected links', () => {
        ...
        cy.get('.mat-mdc-tab-links').should('be.visible')
        ...
        cy.get('.mat-mdc-tab-links a[href="/manufacturer/dyson/nakAxHWxDZprdqkBaCdn4U/overview"]')
