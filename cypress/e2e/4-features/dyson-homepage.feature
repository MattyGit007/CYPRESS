...
Feature: dyson homepage regression tests
    ...
    # Scenario: I verify the back-to-top button works on Dyson homepage
    #     Then I verify the back-to-top button works on Dyson homepage
    ...
    Scenario: I verify that the baseline image snapshot matches the current image shapshot
